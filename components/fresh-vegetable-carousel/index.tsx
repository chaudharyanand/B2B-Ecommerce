  ...
  return (
    <>
      <div className='relative s-mobile:overflow-hidden m-mobile:overflow-hidden  l-mobile:overflow-hidden sm:overflow-hidden md:overflow-hidden lg:overflow-hidden
        lg:flex   
        s-mobile:w-[280px] s-mobile:h-[330px] s-mobile:ml-2
         m-mobile:w-[330px] m-mobile:h-[330px]  
        l-mobile:w-[370px] l-mobile:h-[300px] l-mobile:ml-5
        md:w-[470px] md:h-[300px] 
        lg:w-[760px] lg:h-[300px] lg:-ml-7 lg:-mt-10
        xlg:w-[1034px] xlg:h-[400px] xlg:-ml-7 xlg:-mt-10
        ...
        <div className='  
         ...
         lg:w-[760px] lg:h-[300px] lg:-mr-24
         xlg:w-[1034px] xlg:h-[400px] 
        ...
        >
          {
            products && products.map((prod: any) => (
              <FreshVegetable product={prod} />
            ))
          }
        </div>

        {/* <div className='absolute inset-0 mt-20 lg:mt-20 lg:ml-[8px] md:ml-4 md:mt-30'>
          <button onClick={prev} className='rounded-full shadow float-left mt-10  '>
            <svg className="lg:w-5 xlg:w-6 md:w-5 s-mobile:w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
export default FreshVegetableCarousel;
